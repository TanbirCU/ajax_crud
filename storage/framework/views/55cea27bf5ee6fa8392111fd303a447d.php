...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container">
            ...
            <ul class="navbar-nav">
                <li><a href="<?php echo e(route('master')); ?>" class="nav-link">Home</a></li>
                <li><a href="<?php echo e(route('add-student')); ?>" class="nav-link">Add_Student</a></li>
                <li><a href="<?php echo e(route('add-product')); ?>" class="nav-link">Add-product</a></li>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','.upProductForm',function(e){
            ...
            $.ajax({
                url: "<?php echo e(route('product.edit', '')); ?>" + '/' + id,
                method:'get',
                data:{id: id},
                success:function(res){
        ...
        $(document).on('keyup',function(e){
            ...
            $.ajax({
                url:"<?php echo e(route('product_search')); ?>",
                method:'GET',
        ...
        function productShow(){
            $.ajax({
                url: "<?php echo e(url('productview')); ?>",
                method:'get',
                dataType:'html',
                success:function(res){
                    console.log(res);
...
<?php echo $__env->make('addProduct_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\modal_edit\resources\views/master.blade.php ENDPATH**/ ?>